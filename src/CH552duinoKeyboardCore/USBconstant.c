...
__code uint8_t CfgDesc[] ={
    ...
    // len=7, endpoint, ep1out, interrupt, 64byte, interval(8ms)
    0x07,0x05,0x01,0x03,0x40,0x00,0x08,                       //endpoint descriptor
    // len=7, endpoint, ep1in, interrupt, 64byte, interval(8ms)
    0x07,0x05,0x81,0x03,0x40,0x00,0x08,                       //endpoint descriptor
};
